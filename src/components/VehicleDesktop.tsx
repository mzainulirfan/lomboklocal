...
/**
 * Panel master–detail desktop: daftar pilih kiri + detail sticky kanan.
 * Mobile ditangani komponen server terpisah (kartu + bottom sheet).
 */
export function VehicleDesktop({
  items,
  number,
  labels,
  detailsLabel,
